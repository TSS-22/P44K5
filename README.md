...
At the moment we recommend using [LoopMIDI](https://www.tobias-erichsen.de/software/loopmidi.html) for this. Once installed, open the program and create a virtual MIDI port called `P44D5_virt`. LoopMIDI will need to be running before you start P44D5 everytime.
